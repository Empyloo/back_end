-- remove insert_questions_and_link_to_questionnaire and insert_questions_and_links functions
DROP FUNCTION IF EXISTS insert_questions_and_link_to_questionnaire(questions JSONB, questionnaire_id UUID, created_by UUID, updated_by UUID);
DROP FUNCTION IF EXISTS insert_questions_and_links(questions JSONB, questionnaire_id UUID, user_id UUID);
